...
/**
 * @ClassName: QuTuAdminController
 * @Description: 趣图管理控制器
 * @author lling
 * @date 2015-5-30
 */
@Controller
@RequestMapping("/qutuadmin")
public class QuTuAdminController {
	...
	public String addIndex(HttpSession session, Model model) {
		...
		logger.info("进入添加趣图界面");
		model.addAttribute("users", users);
		return "admin/addQutu";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="/addqutu", method=RequestMethod.POST)
	public String add(@RequestParam String title, @RequestParam(required = true) String imgUrl, 
